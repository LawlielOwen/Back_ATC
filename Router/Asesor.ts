...
router.get('/asesores/consecutivo-folio', AsesorController.obtenerConsecutivoGlobal);
router.put('/asesores/consecutivo-folio', AsesorController.actualizarConsecutivoGlobal);
router.get('/asesores/verificar-folio', AsesorController.verificarFolioGlobal);
